...
-- bufferline
-- 左右Tab切换
map("n", "<leader>ht", ":BufferLineCyclePrev<CR>", opt)
map("n", "<leader>lt", ":BufferLineCycleNext<CR>", opt)
-- "moll/vim-bbye" 关闭当前 buffer
map("n", "<leader>bc", ":Bdelete!<CR>", opt)
map("n", "<C-w>", ":Bdelete!<CR>", opt)
-- 关闭左/右侧标签页
map("n", "<leader>hb", ":BufferLineCloseLeft<CR>", opt)
map("n", "<leader>lb", ":BufferLineCloseRight<CR>", opt)
-- 关闭其他标签页
map("n", "<leader>ob", ":BufferLineCloseRight<CR>:BufferLineCloseLeft<CR>", opt)
-- 关闭选中标签页
map("n", "<leader>pb", ":BufferLinePickClose<CR>", opt)

-- Telescope
map("n", "ff", ":Telescope find_files<CR>", opt)
map("n", "fw", ":Telescope live_grep<CR>", opt)
...
map("n", "<leader>tv", ":ToggleTerm direction=vertical size=80<CR>", opt)
